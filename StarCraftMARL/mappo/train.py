...
from trainer.mapo import MAPOAgentTrainer
...
def get_trainers(env, obs_shape_n, num_actions, arglist):
    trainers = []
    model = mlp_model
...
def train(arglist):
    with U.single_threaded_session():
        ...
        trainers = get_trainers(env, obs_shape_n, num_actions, arglist)
        ...
        while True: 
            ...
            for i, agent in enumerate(trainers):
                ...
                agent_samples = [agent_obs_t, agent_act, agent_ret, agent_logp, agent_adv, agent_val, agent_ava_action]
